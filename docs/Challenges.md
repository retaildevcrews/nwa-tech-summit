...
# Challenge 1 - Build server / working environment 
...
Set up your team’s working environment and build server. Ensure everyone on your team has access to your Azure subscription. 

## Success criteria 

- Your team must be able to SSH into the Ubuntu builder server 
